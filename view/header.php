...
<head>
  ...
  <link rel="icon" href="../public/images/app.ico" type="image/png" />
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="category">
              <i class="fa fa-dedent"></i> <span>Categorias</span>
            </a>
          </li>
          <li class="treeview">
            <a href="brands">
              <i class="fa fa-chain"></i> <span>Marcas</span>
            </a>
          </li>
          <li class="treeview">
            <a href="products">
              <i class="fa 	fa fa-list-ol"></i> <span>Productos</span>
            </a>
          </li>
          <li class="treeview">
            <a href="banners">
          ...
          <li class="treeview">
            <a href="banners">
              <i class="fa fa-home"></i> <span>Banner</span>
            </a>
          </li>
