                    ...
                    <div class="modal-dialog modal-md" role=" document">
                      <div class="modal-content">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" onkeyup="mayus(this);" placeholder="Referencia del producto"
                              ...
                              <div class="col-lg-4 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" onkeyup="mayus(this);" placeholder="Nombre del producto"
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Precio" min="0" name="price"
                                    id="price">
                                </div>
                              </div>
                              <div class="col-lg-3 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                  <label class="control-label">Precio especial</label>
                                  <input type="number" value="0" class="form-control" placeholder="Precio especial"
                                    name="price_e" id="price_e">
                                </div>
                              </div>
                              <div class="col-lg-3 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                  <label class="control-label">Descuento</label>
                                  <input type="text" value="0" class="form-control" placeholder="Descuento"
                            ...
                            <div class="row">
                              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control" placeholder="Especificaciones del producto" rows="5"
                                    name="specs" id="specs"></textarea>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control" placeholder="Descripción del producto" rows="3"
                            ...
                            <div class="row">
                              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" placeholder="Video del producto youtube" class="form-control"
                                    name="embed" id="embed">
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="submit" id="btnsave" class="btn btn-success pull-right">Guardar</button>
                        </div>
                        </form>
                      </div>
                    </div>
